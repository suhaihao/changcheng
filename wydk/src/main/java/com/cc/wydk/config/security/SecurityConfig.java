...
import com.cc.wydk.config.security.token.LindTokenAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().cors().configurationSource(CorsConfigurationSource()).and()
                ...
                .antMatchers("/ten/getPageList").permitAll()
                .antMatchers("/ten/getDetail").permitAll()
                .antMatchers("/order/getByPageList").permitAll()
                .antMatchers("/microfilm/getByPageList").permitAll()
                .antMatchers("/microfilm/detail").permitAll()
                .antMatchers("/articeLikes/getLikeCount").permitAll()
                ...
                .antMatchers("/user/userPrizeConvertPageList").permitAll()
                .antMatchers("/user/userPrizeConvertDetail").permitAll()
